...
function App() {
  ...
  // REFRESCAR / RECUPERAR SESIÓN DE LOCALSTORAGE
  useEffect(() => {
    ...
    if (storedUser) {
        try {
            ...
            // Nos aseguramos de que el objeto recuperado tenga una estructura válida
  ...
  // EFECTO: CARGAR LIBROS AL MONTAR EL COMPONENTE
  useEffect(() => {
    fetchBooks();
  }, []);
